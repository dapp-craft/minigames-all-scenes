...
export const SETTINGS = {
    ...
    obj_num00:     {size: SIZE.MEDIUM, variants: [VARIANT.EASY]},
    obj_num01:     {size: SIZE.MEDIUM, variants: [VARIANT.EASY]},
    obj_num02:     {size: SIZE.MEDIUM, variants: [VARIANT.EASY]},
    obj_num03:     {size: SIZE.MEDIUM, variants: [VARIANT.EASY]},
    obj_num04:     {size: SIZE.MEDIUM, variants: [VARIANT.HARD]},
    obj_num05:     {size: SIZE.MEDIUM, variants: [VARIANT.HARD]},
    obj_num06:     {size: SIZE.MEDIUM, variants: [VARIANT.MEDIUM]},
    obj_num07:     {size: SIZE.MEDIUM, variants: [VARIANT.HARD]},
    obj_num08:     {size: SIZE.MEDIUM, variants: [VARIANT.EASY]},
    obj_num09:     {size: SIZE.MEDIUM, variants: [VARIANT.MEDIUM]},
