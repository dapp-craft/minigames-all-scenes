...
export const tempLocators = new Map([
    ["obj_locator_1", { position: Vector3.create(2, 1, 2) }],
    ["obj_locator_2", { position: Vector3.create(4, 1, 2) }],
    ["obj_locator_3", { position: Vector3.create(6, 1, 2) }],
    ["obj_locator_4", { position: Vector3.create(8, 1, 2) }],
    ["obj_locator_5", { position: Vector3.create(10, 1, 2) }],
    ["obj_locator_6", { position: Vector3.create(12, 1, 2) }],
